...
gpp = {'project_id': '',
       'dataset_id': '',
       'bucket_name': '',
       'directory': 'ml-buy-probability/train',
       'files_path': '/files',
       'model_path': '/model',
...
lstm_features = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'January', 'February',
                 ...
                 'None_event', 'product_page_view', 'purchase', 'add_to_cart', 'event_Na_0', 'event_Na_1', 'event_Na_2',
                 ...
                 'product_unit_price', 'visit_duration', 'visit_nb_pages', 'visit_unique_pages', 'Latitude',
...
new_feature_names = {'Numerical_features':
                         ['product_unit_price', 'visit_duration', 'Latitude', 'Longitude', 'Delta_time'],
                     'Categorical_features':
                         ['week_day', 'month', 'event_env', 'device', 'product_qty', 'visit_nb_pages',
                          'visit_unique_pages', 'product_rating', 'product_number_of_ratings', 'product_lvl_1_name',
                          'product_lvl_2_name', 'product_lvl_3_name'],
                     'Fixed_features':
                         ['inactivity']
                     }

mapping_features = {'num_to_num': ['product_unit_price', 'visit_duration', 'Latitude', 'Longitude', 'Delta_time'],
                    ...
                    'cat_to_cat': ['product_lvl_1_name', 'product_lvl_2_name', 'product_lvl_3_name']}
