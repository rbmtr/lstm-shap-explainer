...
import numpy as np
from shap_explainer import parameters as param
import shap_explainer.utilities as custom_utils
from shap_explainer.preprocessing import preprocessing
import dill
import json
import os
from ml_buy_probability.train_eval_predict import create_input_fn
from ml_buy_probability import parameters
from shap_explainer.custom_explainer import ShapPredictor
...
def explainer_fn(project_id, dataset_id, directory, path_data, bucket_name, date, mode, usage):
    ...
    if mode == 'explain':
        ...
        if usage == 'single':
            ...
            logger.info('Sampling a master_id')
